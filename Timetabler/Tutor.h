...
class Tutor {
    int _ID; // Autoassigned as tutors are added
    string _name;
    ...
    static int _totalTutors; // Total number of tutors. Starts at 0 and increments when tutors are added
...
public:
    ...
    inline static int totalTutors(){ return _totalTutors; }
};
