...
#define __PLATFORM_H__
	...
	/// <summary>This macro is defined when Windows operating system is detected. It is used to handle operating system specifica calls.</summary>
	#define GAL_PLATFORM_WIN

	/// <summary>This macro is defined when Unix-like operating system (Linux, Mac OS X, BSD) is detected.
	/// It is used to handle operating system specifica calls.</summary>
	#define GAL_PLATFORM_NIX

	/// <summary>This macro is defined when Mac OS X operating system is detected. It is used to handle operating system specifica calls.</summary>
	#define GAL_PLATFORM_MACOS

	/// <summary>This macro is defined when Solaris operating system is detected. It is used to handle operating system specifica calls.</summary>
	#define GAL_PLATFORM_SOL

	/// <summary>This macro is defined when Microsoft STL extensions are detected. It is used to handle different STD extensions.</summary>
	#define GAL_STL_EXT_MSVC

	/// <summary>This macro is defined when GNU STL extensions are detected. It is used to handle different STD extensions..</summary>
	#define GAL_STL_EXT_GNUC

	/// <summary>This macro is defined when STLport (Digital Mars and Sun C++) STL extensions are detected.
	/// It is used to handle different STD extensions.</summary>
